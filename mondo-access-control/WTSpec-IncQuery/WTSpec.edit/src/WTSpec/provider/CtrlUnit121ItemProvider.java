...
/**
 * This is the item provider adapter for a {@link WTSpec.CtrlUnit121} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CtrlUnit121ItemProvider extends wtcItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WTSpecPackage.Literals.CTRL_UNIT121__INPUT_IMANUAL_YAW_PRE_COMMAND,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WTSpecPackage.Literals.CTRL_UNIT121__INPUT_IMAX_TWIST_PRE_COMMAND,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WTSpecPackage.Literals.CTRL_UNIT121__INPUT_IRETWIST_PRE_COMMAND,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WTSpecPackage.Literals.CTRL_UNIT121__INPUT_IREL_WIND_PRE_COMMAND,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WTSpecPackage.Literals.CTRL_UNIT121__OUTPUT_OYAW_COMMAND,
				 true,
				 false,
				 true,
				 null,
