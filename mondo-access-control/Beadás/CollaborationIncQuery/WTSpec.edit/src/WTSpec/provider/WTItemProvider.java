...
public class WTItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WTSpecPackage.Literals.WT__SYS_ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WTSpecPackage.Literals.WT__MODEL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WTSpecPackage.Literals.WT__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WTSpecPackage.Literals.WT__ITS_SUBSYSTEMS);
			childrenFeatures.add(WTSpecPackage.Literals.WT__ITS_INPUTS);
			childrenFeatures.add(WTSpecPackage.Literals.WT__ITS_OUTPUTS);
			childrenFeatures.add(WTSpecPackage.Literals.WT__ITS_PARAMS);
			childrenFeatures.add(WTSpecPackage.Literals.WT__ITS_TIMERS);
			childrenFeatures.add(WTSpecPackage.Literals.WT__ITS_FAULTS);
			childrenFeatures.add(WTSpecPackage.Literals.WT__ITS_VARIABLES);
			childrenFeatures.add(WTSpecPackage.Literals.WT__ITS_ERROR_REACTIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WTSpecPackage.Literals.WT__ITS_SUBSYSTEMS,
				 WTSpecFactory.eINSTANCE.createSubsystem()));

		newChildDescriptors.add
			(createChildParameter
				(WTSpecPackage.Literals.WT__ITS_INPUTS,
				 WTSpecFactory.eINSTANCE.createSystemInput()));

		newChildDescriptors.add
			(createChildParameter
				(WTSpecPackage.Literals.WT__ITS_OUTPUTS,
				 WTSpecFactory.eINSTANCE.createSystemOutput()));

		newChildDescriptors.add
			(createChildParameter
				(WTSpecPackage.Literals.WT__ITS_PARAMS,
				 WTSpecFactory.eINSTANCE.createSystemParam()));

		newChildDescriptors.add
			(createChildParameter
				(WTSpecPackage.Literals.WT__ITS_TIMERS,
				 WTSpecFactory.eINSTANCE.createSystemTimer()));

		newChildDescriptors.add
			(createChildParameter
				(WTSpecPackage.Literals.WT__ITS_FAULTS,
				 WTSpecFactory.eINSTANCE.createSystemFault()));

		newChildDescriptors.add
			(createChildParameter
				(WTSpecPackage.Literals.WT__ITS_VARIABLES,
				 WTSpecFactory.eINSTANCE.createSystemVariable()));

		newChildDescriptors.add
			(createChildParameter
				(WTSpecPackage.Literals.WT__ITS_ERROR_REACTIONS,
	...
	public ResourceLocator getResourceLocator() {
		return WTSpecEditPlugin.INSTANCE;
	}
