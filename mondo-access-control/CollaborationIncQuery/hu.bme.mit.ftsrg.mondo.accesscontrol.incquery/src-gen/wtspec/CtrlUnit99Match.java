...
/**
 * Pattern-specific match representation of the wtspec.ctrlUnit99 pattern,
...
public abstract class CtrlUnit99Match extends BasePatternMatch {
  ...
  private CtrlUnit99Match(final Subsystem pS, final String pS_id, final CtrlUnit99 pWTC, final String pC_id) {
    this.fS = pS;
    this.fS_id = pS_id;
    this.fWTC = pWTC;
    this.fC_id = pC_id;
   ...
   * 
   */
  public static CtrlUnit99Match newMutableMatch(final Subsystem pS, final String pS_id, final CtrlUnit99 pWTC, final String pC_id) {
   ...
   * 
   */
  public static CtrlUnit99Match newMatch(final Subsystem pS, final String pS_id, final CtrlUnit99 pWTC, final String pC_id) {
