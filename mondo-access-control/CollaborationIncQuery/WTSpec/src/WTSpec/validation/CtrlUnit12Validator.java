...
/**
 * A sample validator interface for {@link WTSpec.CtrlUnit12}.
 * This doesn't really do anything, and it's not a real EMF artifact.
 * It was generated by the org.eclipse.emf.examples.generator.validator plug-in to illustrate how EMF's code generator can be extended.
 * This can be disabled with -vmargs -Dorg.eclipse.emf.examples.generator.validator=false.
 */
public interface CtrlUnit12Validator {
	boolean validate();

	boolean validateInput__iPinPosition(WTCInput value);
	boolean validateInput__iInductive(WTCInput value);
	boolean validateInput__iFlInPosition(WTCInput value);
	boolean validateInput__iLockingOrder(WTCInput value);
	boolean validateInput__iLockingSet(WTCInput value);
	boolean validateOutput__oPinAutoCmd(WTCOutput value);
