 ...
 * generated by Xtext
 */
package org.mondo.collaboration.security.macl.xtext.ui.contentassist.antlr;
...
public class AccessControlLanguageParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.mondo.collaboration.security.macl.xtext.ui.contentassist.antlr.internal.InternalAccessControlLanguageParser createParser() {
		org.mondo.collaboration.security.macl.xtext.ui.contentassist.antlr.internal.InternalAccessControlLanguageParser result = new org.mondo.collaboration.security.macl.xtext.ui.contentassist.antlr.internal.InternalAccessControlLanguageParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getPolicyAccess().getRulesAlternatives_5_0(), "rule__Policy__RulesAlternatives_5_0");
					...
					put(grammarAccess.getPolicyAccess().getImportsAssignment_4(), "rule__Policy__ImportsAssignment_4");
					put(grammarAccess.getPolicyAccess().getRulesAssignment_5(), "rule__Policy__RulesAssignment_5");
					put(grammarAccess.getRuleRefAccess().getRuleAssignment_1(), "rule__RuleRef__RuleAssignment_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.mondo.collaboration.security.macl.xtext.ui.contentassist.antlr.internal.InternalAccessControlLanguageParser typedParser = (org.mondo.collaboration.security.macl.xtext.ui.contentassist.antlr.internal.InternalAccessControlLanguageParser) parser;
	...
	public AccessControlLanguageGrammarAccess getGrammarAccess() {
