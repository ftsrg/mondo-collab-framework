...
public class SessionChatView extends ViewPart {
	public SessionChatView() {
	}

	private static final class NewMessageArrived implements FutureCallback<Object> {

		private SessionChatView view;

		public NewMessageArrived(SessionChatView view) {
			this.view = view;
		}
	...
	private static final class AddNewSession implements FutureCallback<Object> {
		...
		public void onSuccess(Object arg0) {
			URI uri = (URI) arg0;
			messages.put(uri, "SessionChat started for uri " + uri.toFileString());
		}
	...
	public static final String ID = "org.mondo.collaboration.online.rap.widgets.SessionChatView"; //$NON-NLS-1$

	public static final String EVENT_NEW_MESSAGE = "org.mondo.collaboration.online.rap.widgets.SessionChatView.new.message";
