...
public class OrderedPermitOverridesResolution implements SecurityArbiter.RuleConflictResolver {
	...
	public OrderedPermitOverridesResolution(List<Rule> rules) {
		super();
			...
			if (asset instanceof ObjectAsset) {
				...
				if (referenceAsset.getSource() == objectAsset.getObject()
					...
					if (objectRuleType == RuleType.DENY && referenceRuleType == RuleType.PERMIT) {
						SecurityRuleJudgement newJudgement = createDummyJudgement(objectAsset, null, RuleRights.READ,
