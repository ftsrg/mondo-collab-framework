...
/**
 * This is the item provider adapter for a {@link WTSpec.Subsystem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubsystemItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WTSpecPackage.Literals.SUBSYSTEM__SYS_ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WTSpecPackage.Literals.SUBSYSTEM__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WTSpecPackage.Literals.SUBSYSTEM__ITS_WT_CS);
			childrenFeatures.add(WTSpecPackage.Literals.SUBSYSTEM__ITS_SUBSYSTEMS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WTSpecPackage.Literals.SUBSYSTEM__ITS_WT_CS,
		...
		newChildDescriptors.add
			(createChildParameter
				(WTSpecPackage.Literals.SUBSYSTEM__ITS_SUBSYSTEMS,
