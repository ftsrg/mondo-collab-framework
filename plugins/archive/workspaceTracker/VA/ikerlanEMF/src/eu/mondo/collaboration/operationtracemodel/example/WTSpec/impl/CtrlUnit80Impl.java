...
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.CtrlUnit80;
 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit80Impl#getInput__iAccessState <em>Input iAccess State</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit80Impl#getInput__iMaintenanceStatus <em>Input iMaintenance Status</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit80Impl#getInput__iButtonStateNC2 <em>Input iButton State NC2</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit80Impl#getInput__iButtonStateTC <em>Input iButton State TC</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit80Impl#getInput__iButtonStateRemote <em>Input iButton State Remote</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit80Impl#getOutput__oButtonState <em>Output oButton State</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
