 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit90Impl#getInput__iStatusR <em>Input iStatus R</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit90Impl#getInput__iStatusS <em>Input iStatus S</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit90Impl#getInput__iStatusT <em>Input iStatus T</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit90Impl#getInput__iValueR <em>Input iValue R</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit90Impl#getInput__iValueS <em>Input iValue S</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit90Impl#getInput__iValueT <em>Input iValue T</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit90Impl#getOutput__oCosinePhi <em>Output oCosine Phi</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit90Impl#getOutput__oFrequency <em>Output oFrequency</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit90Impl#getOutput__oControlR <em>Output oControl R</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit90Impl#getOutput__oControlS <em>Output oControl S</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit90Impl#getOutput__oControlT <em>Output oControl T</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit90Impl#getOutput__oApparentPower <em>Output oApparent Power</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit90Impl#getOutput__oVoltageR <em>Output oVoltage R</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit90Impl#getOutput__oVoltageS <em>Output oVoltage S</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit90Impl#getOutput__oVoltageT <em>Output oVoltage T</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit90Impl#getOutput__oCurrentR <em>Output oCurrent R</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit90Impl#getOutput__oCurrentS <em>Output oCurrent S</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit90Impl#getOutput__oCurrentT <em>Output oCurrent T</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit90Impl#getParameter__pCurrentFactor <em>Parameter pCurrent Factor</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit90Impl#getParameter__pVoltageFactor <em>Parameter pVoltage Factor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
