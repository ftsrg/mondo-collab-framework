...
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.CtrlUnit9;
 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit9Impl#getInput__iValueToCheck <em>Input iValue To Check</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit9Impl#getInput__iDontCheckInput <em>Input iDont Check Input</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit9Impl#getInput__iLimitValue <em>Input iLimit Value</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit9Impl#getInput__iLimitReset <em>Input iLimit Reset</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit9Impl#getOutput__oLimitReached <em>Output oLimit Reached</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit9Impl#getParameter__pLimitValue <em>Parameter pLimit Value</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit9Impl#getParameter__pLimitReset <em>Parameter pLimit Reset</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit9Impl#getTimer__tDelay <em>Timer tDelay</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit9Impl#getBhvParam__bpMode <em>Bhv Param bp Mode</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit9Impl#getBhvParam__bpLimitsType <em>Bhv Param bp Limits Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
