 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit86Impl#getInput__iPitchHwStandby <em>Input iPitch Hw Standby</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit86Impl#getInput__iPitchHwFault <em>Input iPitch Hw Fault</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit86Impl#getInput__iPitchStopCommand <em>Input iPitch Stop Command</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit86Impl#getInput__iPitchBrakePosition <em>Input iPitch Brake Position</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit86Impl#getOutput__oBrakes <em>Output oBrakes</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit86Impl#getOutput__oPitchNormalOrder <em>Output oPitch Normal Order</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit86Impl#getOutput__oPitchEmergencyOrder <em>Output oPitch Emergency Order</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit86Impl#getOutput__oPitchTestUCapOrder <em>Output oPitch Test UCap Order</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit86Impl#getErrorReaction__erEmergency <em>Error Reaction er Emergency</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit86Impl#getErrorReaction__erSecurityLine <em>Error Reaction er Security Line</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
