 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit26Impl#getInput__iCounter <em>Input iCounter</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit26Impl#getInput__iActivator <em>Input iActivator</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit26Impl#getOutput__oCounter <em>Output oCounter</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit26Impl#getOutput__oLimitReached <em>Output oLimit Reached</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit26Impl#getParameter__pLimit <em>Parameter pLimit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
