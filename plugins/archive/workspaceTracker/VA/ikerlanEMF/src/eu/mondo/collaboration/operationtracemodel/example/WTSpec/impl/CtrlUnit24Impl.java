 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit24Impl#getInput__iInverterReady <em>Input iInverter Ready</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit24Impl#getInput__iInverterPower <em>Input iInverter Power</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit24Impl#getInput__iAlgorithmCommand <em>Input iAlgorithm Command</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit24Impl#getParameter__pPowerLimit <em>Parameter pPower Limit</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit24Impl#getFault__fYawProblem <em>Fault fYaw Problem</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit24Impl#getTimer__tDelayProblemNotify <em>Timer tDelay Problem Notify</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit24Impl#getDecisionSequence__dsDecisionTree <em>Decision Sequence ds Decision Tree</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
