...
public class OrderedPermitOverridesTest extends AbstractTestBase {
	...
	public void sameAssetPermitAll() throws IncQueryException {
		...
		String policyPath = "D:\\Modelling\\git\\mondo-collab-framework\\plugins\\"
				...
				+ "mondo\\collaboration\\security\\lens\\test\\algorithm\\orderedPermitOverridesRulesPermitAll.macl";
	...
	public void sameAssetDenyAll() throws IncQueryException {
		...
		String policyPath = "D:\\Modelling\\git\\mondo-collab-framework\\plugins\\"
				+ "org.mondo.collaboration.security.lens.test.algorithm\\src\\org\\"
				+ "mondo\\collaboration\\security\\lens\\test\\algorithm\\orderedPermitOverridesRulesDenyAll.macl";
	...
	public void differentAssetPermitReference() throws IncQueryException {
		...
		String policyPath = "D:\\Modelling\\git\\mondo-collab-framework\\plugins\\"
				+ "org.mondo.collaboration.security.lens.test.algorithm\\src\\org\\"
				+ "mondo\\collaboration\\security\\lens\\test\\algorithm\\orderedPermitOverridesRulesPermitRreference.macl";
		...
		//differentAssetPermitReference test
		Assert.assertEquals(1, system.getOutputs().size());
		Assert.assertEquals(1, system.getInputs().size());
	...
	public void differentAssetPermitAttribute() throws IncQueryException {
		...
		String policyPath = "D:\\Modelling\\git\\mondo-collab-framework\\plugins\\"
				+ "org.mondo.collaboration.security.lens.test.algorithm\\src\\org\\"
				+ "mondo\\collaboration\\security\\lens\\test\\algorithm\\orderedPermitOverridesRulesPermitAttribute.macl";
		...
		//differentAssetPermitAttribute test
		Assert.assertEquals(1, system.getOutputs().size());
		Assert.assertEquals(1, system.getInputs().size());
