...
public class OrderedDenyOverridesTest extends AbstractTestBase {
	...
	public void sameAssetPermitAll() throws IncQueryException {
		...
		String policyPath = "D:\\Modelling\\git\\mondo-collab-framework\\plugins\\"
				...
				+ "mondo\\collaboration\\security\\lens\\test\\algorithm\\orderedDenyOverridesRulesPermitAll.macl";
	...
	public void sameAssetDenyAll() throws IncQueryException {
		...
		String policyPath = "D:\\Modelling\\git\\mondo-collab-framework\\plugins\\"
				+ "org.mondo.collaboration.security.lens.test.algorithm\\src\\org\\"
				+ "mondo\\collaboration\\security\\lens\\test\\algorithm\\orderedDenyOverridesRulesDenyAll.macl";
	...
	public void differentAssetPermitInputs() throws IncQueryException {
		...
		String policyPath = "D:\\Modelling\\git\\mondo-collab-framework\\plugins\\"
				+ "org.mondo.collaboration.security.lens.test.algorithm\\src\\org\\"
				+ "mondo\\collaboration\\security\\lens\\test\\algorithm\\orderedDenyOverridesRulesPermitInputs.macl";
		...
		//differentAssetPermitInputs test
		Assert.assertEquals(1, system.getOutputs().size());
		Assert.assertEquals(1, system.getInputs().size());
