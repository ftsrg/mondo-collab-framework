...
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.CtrlUnit65;
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.WTSpecPackage;

/**
 * This is the item provider adapter for a {@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.CtrlUnit65} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CtrlUnit65ItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CtrlUnit65_Output__oOutput_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CtrlUnit65_Output__oOutput_feature", "_UI_CtrlUnit65_type"),
				 WTSpecPackage.eINSTANCE.getCtrlUnit65_Output__oOutput(),
				 true,
				 false,
				 true,
				 null,
	...
	protected void addFault__fFaultPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CtrlUnit65_Fault__fFault_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CtrlUnit65_Fault__fFault_feature", "_UI_CtrlUnit65_type"),
				 WTSpecPackage.eINSTANCE.getCtrlUnit65_Fault__fFault(),
				 true,
				 false,
				 true,
				 null,
