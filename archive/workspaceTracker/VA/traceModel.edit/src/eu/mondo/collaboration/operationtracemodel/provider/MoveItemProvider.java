...
/**
 * This is the item provider adapter for a {@link eu.mondo.collaboration.operationtracemodel.Move} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MoveItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Move_oldIndex_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Move_oldIndex_feature", "_UI_Move_type"),
				 OperationtracemodelPackage.Literals.MOVE__OLD_INDEX,
				 true,
				 false,
				 false,
	...
	protected void addNewIndexPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Move_newIndex_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Move_newIndex_feature", "_UI_Move_type"),
				 OperationtracemodelPackage.Literals.MOVE__NEW_INDEX,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Move_type") + " " + move.getOldIndex();
	}
