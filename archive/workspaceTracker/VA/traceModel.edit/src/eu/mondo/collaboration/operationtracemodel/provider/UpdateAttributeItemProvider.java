...
/**
 * This is the item provider adapter for a {@link eu.mondo.collaboration.operationtracemodel.UpdateAttribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UpdateAttributeItemProvider
	extends UpdateItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UpdateAttribute_newValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UpdateAttribute_newValue_feature", "_UI_UpdateAttribute_type"),
				 OperationtracemodelPackage.Literals.UPDATE_ATTRIBUTE__NEW_VALUE,
				 true,
				 false,
				 false,
	...
	protected void addOldValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UpdateAttribute_oldValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UpdateAttribute_oldValue_feature", "_UI_UpdateAttribute_type"),
				 OperationtracemodelPackage.Literals.UPDATE_ATTRIBUTE__OLD_VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		Object labelValue = ((UpdateAttribute)object).getNewValue();
