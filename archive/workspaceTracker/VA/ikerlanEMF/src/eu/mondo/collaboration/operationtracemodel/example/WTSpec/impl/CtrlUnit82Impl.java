...
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.CtrlUnit82;
 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit82Impl#getInput__iVarInput <em>Input iVar Input</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit82Impl#getInput__iWriteTwistAngleRequest <em>Input iWrite Twist Angle Request</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit82Impl#getInput__iNewTwistAngleValue <em>Input iNew Twist Angle Value</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit82Impl#getOutput__oVarOutput <em>Output oVar Output</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit82Impl#getParameter__pMinDifferenceToConsider <em>Parameter pMin Difference To Consider</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit82Impl#getTimer__tSyncDelay <em>Timer tSync Delay</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
