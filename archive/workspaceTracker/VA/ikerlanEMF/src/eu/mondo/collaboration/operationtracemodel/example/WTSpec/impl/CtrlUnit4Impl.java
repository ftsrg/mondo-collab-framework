...
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.CtrlUnit4;
 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit4Impl#getInput__iStatus <em>Input iStatus</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit4Impl#getInput__iOverloadAlarm <em>Input iOverload Alarm</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit4Impl#getInput__iAlarmCounter <em>Input iAlarm Counter</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit4Impl#getOutput__oAlarmCounter <em>Output oAlarm Counter</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit4Impl#getParameter__pAlarmCountLimit <em>Parameter pAlarm Count Limit</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit4Impl#getParameter__pTimePeriod <em>Parameter pTime Period</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit4Impl#getFault__fOverload <em>Fault fOverload</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit4Impl#getTimer__tSyncDelay <em>Timer tSync Delay</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
