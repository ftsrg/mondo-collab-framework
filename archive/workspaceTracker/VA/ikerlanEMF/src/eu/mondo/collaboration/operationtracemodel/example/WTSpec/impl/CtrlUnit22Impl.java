 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit22Impl#getInput__iYawStatus <em>Input iYaw Status</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit22Impl#getInput__iTwistAngle <em>Input iTwist Angle</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit22Impl#getInput__iMaxTwistCW <em>Input iMax Twist CW</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit22Impl#getInput__iMaxTwistCCW <em>Input iMax Twist CCW</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit22Impl#getOutput__oMaxTwistPreCommand <em>Output oMax Twist Pre Command</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit22Impl#getParameter__pMaxTwistHysteresis <em>Parameter pMax Twist Hysteresis</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit22Impl#getFault__fTwistExcessiveCW <em>Fault fTwist Excessive CW</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit22Impl#getFault__fTwistExcessiveCCW <em>Fault fTwist Excessive CCW</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
