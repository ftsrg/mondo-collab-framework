...
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.CtrlUnit54;
 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit54Impl#getInput__iSafety <em>Input iSafety</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit54Impl#getInput__iLockingOrderSelected <em>Input iLocking Order Selected</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit54Impl#getInput__iMachineStateL <em>Input iMachine State L</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit54Impl#getInput__iMachineStateU <em>Input iMachine State U</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit54Impl#getInput__iMachineStateS <em>Input iMachine State S</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit54Impl#getInput__iInitialConditions <em>Input iInitial Conditions</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit54Impl#getInput__iPinState <em>Input iPin State</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit54Impl#getOutput__oLockingOrder <em>Output oLocking Order</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
