 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit83Impl#getInput__iPinSafetyCmd <em>Input iPin Safety Cmd</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit83Impl#getInput__iPinAutoCmd <em>Input iPin Auto Cmd</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit83Impl#getInput__iPinManualCmd <em>Input iPin Manual Cmd</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit83Impl#getInput__iLockingSet <em>Input iLocking Set</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit83Impl#getInput__iManualMode <em>Input iManual Mode</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit83Impl#getInput__iSafetyBlock <em>Input iSafety Block</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit83Impl#getOutput__oPinEnable <em>Output oPin Enable</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit83Impl#getOutput__oPinExtend <em>Output oPin Extend</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit83Impl#getOutput__oPinRetract <em>Output oPin Retract</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
