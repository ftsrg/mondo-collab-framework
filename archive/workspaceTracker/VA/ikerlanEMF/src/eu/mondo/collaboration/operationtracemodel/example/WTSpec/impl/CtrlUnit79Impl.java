 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit79Impl#getInput__iOverPressureCmd <em>Input iOver Pressure Cmd</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit79Impl#getOutput__oYawBrakeHighPressureCmd <em>Output oYaw Brake High Pressure Cmd</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit79Impl#getFault__fYawBrakeBlock <em>Fault fYaw Brake Block</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit79Impl#getFault__fYawBrakeLoose <em>Fault fYaw Brake Loose</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit79Impl#getFault__fYawBrakeActive <em>Fault fYaw Brake Active</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit79Impl#getFault__fWarning <em>Fault fWarning</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit79Impl#getFault__fFault <em>Fault fFault</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit79Impl#getDecisionSequence__dsCommands <em>Decision Sequence ds Commands</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
