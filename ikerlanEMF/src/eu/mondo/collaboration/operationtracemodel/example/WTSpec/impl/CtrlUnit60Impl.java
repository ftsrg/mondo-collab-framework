...
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.CtrlUnit60;
 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit60Impl#getInput__iDisconnect <em>Input iDisconnect</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit60Impl#getInput__iStopCommand <em>Input iStop Command</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit60Impl#getInput__iPitchBraked <em>Input iPitch Braked</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit60Impl#getInput__iInverterRpm <em>Input iInverter Rpm</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit60Impl#getInput__iReadyForOn <em>Input iReady For On</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit60Impl#getInput__iReadyForRun <em>Input iReady For Run</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit60Impl#getInput__iReadyForRef <em>Input iReady For Ref</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit60Impl#getInput__iResetOrder <em>Input iReset Order</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit60Impl#getInput__iForceInvOff <em>Input iForce Inv Off</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit60Impl#getInput__iSafetyInput <em>Input iSafety Input</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit60Impl#getOutput__oInverterRun <em>Output oInverter Run</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit60Impl#getOutput__oInverterToOn <em>Output oInverter To On</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit60Impl#getParameter__pInverterConnSpeed <em>Parameter pInverter Conn Speed</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit60Impl#getParameter__pInverterConnSpeedHysteresis <em>Parameter pInverter Conn Speed Hysteresis</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit60Impl#getFault__fReconnectWarning <em>Fault fReconnect Warning</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit60Impl#getFault__fReadyRefWarning <em>Fault fReady Ref Warning</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit60Impl#getTimer__tConnection <em>Timer tConnection</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit60Impl#getTimer__tRunningDelay <em>Timer tRunning Delay</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
