...
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.CtrlUnit61;
 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit61Impl#getInput__iInverterToOnOrder <em>Input iInverter To On Order</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit61Impl#getInput__iInverterReadyRef <em>Input iInverter Ready Ref</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit61Impl#getInput__iRemoteResetOrder <em>Input iRemote Reset Order</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit61Impl#getInput__iInverterTorqueReg <em>Input iInverter Torque Reg</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit61Impl#getInput__iInverterHwState <em>Input iInverter Hw State</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit61Impl#getInput__iResetOrder <em>Input iReset Order</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit61Impl#getInput__iMotorizing <em>Input iMotorizing</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit61Impl#getOutput__oInverterToOn <em>Output oInverter To On</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit61Impl#getOutput__oInverterResetCommand <em>Output oInverter Reset Command</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit61Impl#getOutput__oInverterTorqueRef <em>Output oInverter Torque Ref</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit61Impl#getOutput__oInverterResetAlarms <em>Output oInverter Reset Alarms</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit61Impl#getFault__fEtherCAT <em>Fault fEther CAT</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit61Impl#getTimer__tResetTime <em>Timer tReset Time</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit61Impl#getTimer__tDelayBetweenResets <em>Timer tDelay Between Resets</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit61Impl#getErrorReaction__erStop <em>Error Reaction er Stop</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
