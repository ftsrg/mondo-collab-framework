...
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.CtrlUnit66;
 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit66Impl#getInput__iMaintenancePreventiveButton <em>Input iMaintenance Preventive Button</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit66Impl#getInput__iMaintenanceCorrectiveButton <em>Input iMaintenance Corrective Button</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit66Impl#getInput__iDontCheckInput <em>Input iDont Check Input</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit66Impl#getOutput__oMaintenanceStatus <em>Output oMaintenance Status</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit66Impl#getFault__fMaintenancePreventive <em>Fault fMaintenance Preventive</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit66Impl#getFault__fMaintenanceCorrective <em>Fault fMaintenance Corrective</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
