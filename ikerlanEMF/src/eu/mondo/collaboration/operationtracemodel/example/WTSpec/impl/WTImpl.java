...
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.SystemFault;
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.SystemInput;
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.SystemOutput;
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.SystemParam;
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.SystemTimer;
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.SystemVariable;
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.WT;
 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.WTImpl#getSysId <em>Sys Id</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.WTImpl#getModel <em>Model</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.WTImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.WTImpl#getItsSubsystems <em>Its Subsystems</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.WTImpl#getItsInputs <em>Its Inputs</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.WTImpl#getItsOutputs <em>Its Outputs</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.WTImpl#getItsParams <em>Its Params</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.WTImpl#getItsTimers <em>Its Timers</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.WTImpl#getItsFaults <em>Its Faults</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.WTImpl#getItsVariables <em>Its Variables</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.WTImpl#getItsErrorReactions <em>Its Error Reactions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
