...
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.CtrlUnit100;
 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit100Impl#getInput__iPinPosition <em>Input iPin Position</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit100Impl#getOutput__oPinSafetyCmd <em>Output oPin Safety Cmd</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit100Impl#getParameter__pPinNoBackPos <em>Parameter pPin No Back Pos</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit100Impl#getParameter__pPinExtendedPos <em>Parameter pPin Extended Pos</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit100Impl#getParameter__pPinRetractedPos <em>Parameter pPin Retracted Pos</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit100Impl#getParameter__pPinHysteresis <em>Parameter pPin Hysteresis</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit100Impl#getBhvParam__bpMode <em>Bhv Param bp Mode</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
