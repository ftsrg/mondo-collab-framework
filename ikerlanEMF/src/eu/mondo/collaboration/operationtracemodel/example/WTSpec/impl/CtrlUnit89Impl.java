 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit89Impl#getInput__iAngleReference1 <em>Input iAngle Reference1</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit89Impl#getInput__iAngleReference2 <em>Input iAngle Reference2</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit89Impl#getInput__iAngleReference3 <em>Input iAngle Reference3</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit89Impl#getInput__iSpeedReference <em>Input iSpeed Reference</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit89Impl#getInput__iAccelerationReference <em>Input iAcceleration Reference</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit89Impl#getInput__iPitchManualControl <em>Input iPitch Manual Control</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit89Impl#getInput__iPitchManualAngle <em>Input iPitch Manual Angle</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit89Impl#getInput__iMaintenanceStatus <em>Input iMaintenance Status</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit89Impl#getInput__iGeneratorSpeed <em>Input iGenerator Speed</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit89Impl#getInput__iPitchBraked <em>Input iPitch Braked</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit89Impl#getOutput__oPitchAngleRef1 <em>Output oPitch Angle Ref1</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit89Impl#getOutput__oPitchAngleRef2 <em>Output oPitch Angle Ref2</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit89Impl#getOutput__oPitchAngleRef3 <em>Output oPitch Angle Ref3</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit89Impl#getOutput__oPitchSpeedRef <em>Output oPitch Speed Ref</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit89Impl#getOutput__oPitchAccelerationRef <em>Output oPitch Acceleration Ref</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit89Impl#getOutput__oPitchStopCommand <em>Output oPitch Stop Command</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit89Impl#getParameter__pGeneratorSpeed <em>Parameter pGenerator Speed</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit89Impl#getParameter__pPitchBrakeAngle <em>Parameter pPitch Brake Angle</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit89Impl#getParameter__pPitchStdSpeed <em>Parameter pPitch Std Speed</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit89Impl#getParameter__pPitchStdAcceleration <em>Parameter pPitch Std Acceleration</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit89Impl#getFault__fManualStop <em>Fault fManual Stop</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit89Impl#getTimer__tMaxStopOperationLength <em>Timer tMax Stop Operation Length</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit89Impl#getErrorReaction__erStop <em>Error Reaction er Stop</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
