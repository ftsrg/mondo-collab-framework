 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit116Impl#getInput__iInhibitAutoYawCondition <em>Input iInhibit Auto Yaw Condition</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit116Impl#getInput__iInhibitYawCondition <em>Input iInhibit Yaw Condition</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit116Impl#getOutput__oInhibitAutoYaw <em>Output oInhibit Auto Yaw</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit116Impl#getOutput__oInhibitYaw <em>Output oInhibit Yaw</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit116Impl#getOutput__oYawStatus <em>Output oYaw Status</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
