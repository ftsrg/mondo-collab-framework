...
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.CtrlUnit75;
 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit75Impl#getInput__iMaintenanceStatus <em>Input iMaintenance Status</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit75Impl#getInput__iFlBrakes <em>Input iFl Brakes</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit75Impl#getInput__iWTGStopped <em>Input iWTG Stopped</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit75Impl#getInput__iGridError <em>Input iGrid Error</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit75Impl#getInput__iReTwisting <em>Input iRe Twisting</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit75Impl#getInput__iHiWind <em>Input iHi Wind</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit75Impl#getInput__iHiGust <em>Input iHi Gust</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit75Impl#getInput__iLowWind <em>Input iLow Wind</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit75Impl#getInput__iBackWind <em>Input iBack Wind</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit75Impl#getInput__iEnEstela <em>Input iEn Estela</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit75Impl#getOutput__oOpcTurbineStatus <em>Output oOpc Turbine Status</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
