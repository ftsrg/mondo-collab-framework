 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit126Impl#getInput__iTorqueVal <em>Input iTorque Val</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit126Impl#getInput__iInvRol <em>Input iInv Rol</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit126Impl#getOutput__oMaxTorque <em>Output oMax Torque</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit126Impl#getOutput__oMinTorque <em>Output oMin Torque</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit126Impl#getParameter__pMaxTorque <em>Parameter pMax Torque</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit126Impl#getParameter__pMinTorque <em>Parameter pMin Torque</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
