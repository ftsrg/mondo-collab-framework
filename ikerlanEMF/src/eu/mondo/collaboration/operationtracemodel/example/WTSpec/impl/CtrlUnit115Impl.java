 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit115Impl#getInput__iWindSpeedRaw <em>Input iWind Speed Raw</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit115Impl#getOutput__oWindSpeed <em>Output oWind Speed</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit115Impl#getOutput__oWindSpeedAverage <em>Output oWind Speed Average</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit115Impl#getParameter__pNacelleSlope <em>Parameter pNacelle Slope</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit115Impl#getParameter__pNacelleOffset <em>Parameter pNacelle Offset</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit115Impl#getParameter__pWindSpeedAveragePeriod <em>Parameter pWind Speed Average Period</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
