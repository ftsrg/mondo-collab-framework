 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit122Impl#getInput__iYawCommand <em>Input iYaw Command</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit122Impl#getInput__iYawBrakeStatus <em>Input iYaw Brake Status</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit122Impl#getInput__iInhibitYaw <em>Input iInhibit Yaw</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit122Impl#getOutput__oYawStatus <em>Output oYaw Status</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit122Impl#getOutput__oYawBrakeCommand <em>Output oYaw Brake Command</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit122Impl#getOutput__oYawCwOrder <em>Output oYaw Cw Order</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit122Impl#getOutput__oYawCcwOrder <em>Output oYaw Ccw Order</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit122Impl#getTimer__tDelayYawingControl <em>Timer tDelay Yawing Control</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit122Impl#getTimer__tDelayYawingToStop <em>Timer tDelay Yawing To Stop</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
