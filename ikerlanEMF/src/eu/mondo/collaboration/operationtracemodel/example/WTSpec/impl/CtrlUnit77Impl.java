...
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.CtrlUnit77;
 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit77Impl#getInput__iYawInhibited <em>Input iYaw Inhibited</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit77Impl#getInput__iYawCwOrder <em>Input iYaw Cw Order</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit77Impl#getInput__iYawCcwOrder <em>Input iYaw Ccw Order</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit77Impl#getInput__iFlagIntoWind <em>Input iFlag Into Wind</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit77Impl#getOutput__oOpcYawStatus <em>Output oOpc Yaw Status</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
