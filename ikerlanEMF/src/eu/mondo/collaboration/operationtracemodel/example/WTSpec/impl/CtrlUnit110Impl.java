...
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.CtrlUnit110;
 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit110Impl#getInput__iManualStopRequest <em>Input iManual Stop Request</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit110Impl#getInput__iRemoteStopRequest <em>Input iRemote Stop Request</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit110Impl#getInput__iManualStartRequest <em>Input iManual Start Request</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit110Impl#getInput__iRemoteStartRequest <em>Input iRemote Start Request</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit110Impl#getInput__iStopped <em>Input iStopped</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit110Impl#getOutput__oMachineStopOrder <em>Output oMachine Stop Order</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
