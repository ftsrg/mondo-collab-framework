 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit133Impl#getInput__iYawStatus <em>Input iYaw Status</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit133Impl#getInput__iYawCurrent1 <em>Input iYaw Current1</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit133Impl#getInput__iYawCurrent2 <em>Input iYaw Current2</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit133Impl#getInput__iYawCurrent3 <em>Input iYaw Current3</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit133Impl#getInput__iYawCurrent4 <em>Input iYaw Current4</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit133Impl#getInput__iOverloadAlarmCounter <em>Input iOverload Alarm Counter</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit133Impl#getOutput__oOverloadAlarmCounter <em>Output oOverload Alarm Counter</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit133Impl#getParameter__pMaximumTorque <em>Parameter pMaximum Torque</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit133Impl#getParameter__pMinimumTorque <em>Parameter pMinimum Torque</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit133Impl#getParameter__pTorqueDifferenceLimit <em>Parameter pTorque Difference Limit</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit133Impl#getFault__fFault <em>Fault fFault</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit133Impl#getTimer__tTimer <em>Timer tTimer</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
