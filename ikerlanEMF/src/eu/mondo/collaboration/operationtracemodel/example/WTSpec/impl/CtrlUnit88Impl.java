 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit88Impl#getInput__iPthResetCommand <em>Input iPth Reset Command</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit88Impl#getInput__iPthResetOrder <em>Input iPth Reset Order</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit88Impl#getOutput__oPthResetCommand <em>Output oPth Reset Command</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit88Impl#getOutput__oPthResetOrder <em>Output oPth Reset Order</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit88Impl#getOutput__oPthReset <em>Output oPth Reset</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit88Impl#getTimer__tResetTimer <em>Timer tReset Timer</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit88Impl#getTimer__tTimeBetweenResets <em>Timer tTime Between Resets</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
