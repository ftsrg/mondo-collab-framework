...
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.CtrlUnit49;
 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit49Impl#getInput__iInput1 <em>Input iInput1</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit49Impl#getInput__iInput2 <em>Input iInput2</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit49Impl#getInput__iInput3 <em>Input iInput3</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit49Impl#getInput__iInput4 <em>Input iInput4</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit49Impl#getOutput__oOutputFan1 <em>Output oOutput Fan1</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit49Impl#getOutput__oOutputFan2 <em>Output oOutput Fan2</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit49Impl#getParameter__pParam1 <em>Parameter pParam1</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit49Impl#getParameter__pParam2 <em>Parameter pParam2</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit49Impl#getParameter__pParam3 <em>Parameter pParam3</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit49Impl#getParameter__pParam4 <em>Parameter pParam4</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit49Impl#getFault__fFault1 <em>Fault fFault1</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit49Impl#getTimer__tTimer1 <em>Timer tTimer1</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit49Impl#getErrorReaction__eReaction1 <em>Error Reaction eReaction1</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit49Impl#getErrorReaction__eReaction2 <em>Error Reaction eReaction2</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit49Impl#getGuard__gGuardErrors <em>Guard gGuard Errors</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit49Impl#getGuard__gGuardNoErrors <em>Guard gGuard No Errors</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit49Impl#getGuard__gGuardOffToHi <em>Guard gGuard Off To Hi</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit49Impl#getGuard__gGuardHiToOff <em>Guard gGuard Hi To Off</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit49Impl#getGuard__gGuardOffToLow <em>Guard gGuard Off To Low</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit49Impl#getGuard__gGuardLowToOff <em>Guard gGuard Low To Off</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit49Impl#getGuard__gGuardLowToHi <em>Guard gGuard Low To Hi</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit49Impl#getGuard__gGuardHiToLow <em>Guard gGuard Hi To Low</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
