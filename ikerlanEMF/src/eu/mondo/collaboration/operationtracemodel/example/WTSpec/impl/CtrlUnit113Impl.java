 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit113Impl#getInput__iWindSpeed <em>Input iWind Speed</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit113Impl#getInput__iWindSpeedAverage <em>Input iWind Speed Average</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit113Impl#getOutput__oExcessiveWindAcceleration <em>Output oExcessive Wind Acceleration</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit113Impl#getParameter__pConsideredTime <em>Parameter pConsidered Time</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit113Impl#getParameter__pWindAccelerationLimit <em>Parameter pWind Acceleration Limit</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit113Impl#getParameter__pHiWindLimitReset <em>Parameter pHi Wind Limit Reset</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit113Impl#getParameter__pMaxAbsoluteWindSpeed <em>Parameter pMax Absolute Wind Speed</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
