...
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.CtrlUnit127;
 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit127Impl#getInput__iLowWindActive <em>Input iLow Wind Active</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit127Impl#getInput__iWindDirectionRelAvg <em>Input iWind Direction Rel Avg</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit127Impl#getInput__iTwistAngle <em>Input iTwist Angle</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit127Impl#getInput__iInhibitAutoYaw <em>Input iInhibit Auto Yaw</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit127Impl#getOutput__oRelWindPreCommand <em>Output oRel Wind Pre Command</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit127Impl#getOutput__oFlagIntoWind <em>Output oFlag Into Wind</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit127Impl#getOutput__oExcessiveYawingTime <em>Output oExcessive Yawing Time</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit127Impl#getParameter__pWindDirectionTolerance <em>Parameter pWind Direction Tolerance</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit127Impl#getParameter__pYawFilterTime <em>Parameter pYaw Filter Time</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit127Impl#getParameter__pYawStopAngleLimit <em>Parameter pYaw Stop Angle Limit</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit127Impl#getTimer__tMaximumTimeYawing <em>Timer tMaximum Time Yawing</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
