...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.client.incquery.studentOfSchool pattern,
...
public class StudentOfSchoolMatcher extends BaseMatcher<StudentOfSchoolMatch> {
  ...
  private final static org.apache.log4j.Logger LOGGER = IncQueryLoggingUtil.getLogger(StudentOfSchoolMatcher.class);
