...
/**
 * Generated pattern matcher API of the org.mondo.collaboration.client.incquery.courseWithPrimeWeight pattern,
...
public class CourseWithPrimeWeightMatcher extends BaseMatcher<CourseWithPrimeWeightMatch> {
  ...
  private final static org.apache.log4j.Logger LOGGER = IncQueryLoggingUtil.getLogger(CourseWithPrimeWeightMatcher.class);
