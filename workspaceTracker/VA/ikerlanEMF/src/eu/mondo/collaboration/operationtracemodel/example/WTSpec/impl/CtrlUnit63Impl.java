 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getInput__iAzimuth <em>Input iAzimuth</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getInput__iOrder <em>Input iOrder</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getInput__iTargetHole <em>Input iTarget Hole</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getInput__iInvReadyRef <em>Input iInv Ready Ref</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getInput__iEncoderSpeed <em>Input iEncoder Speed</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getInput__iInductiveSensor1 <em>Input iInductive Sensor1</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getInput__iInductiveSensor2 <em>Input iInductive Sensor2</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getOutput__oMotorTorque <em>Output oMotor Torque</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getOutput__oMotorSense <em>Output oMotor Sense</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getOutput__oFlIntoPosition <em>Output oFl Into Position</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getOutput__oStatusFromDll <em>Output oStatus From Dll</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getOutput__oPositionSetpoint <em>Output oPosition Setpoint</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getOutput__oTorqueAve <em>Output oTorque Ave</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getOutput__oErrorAve <em>Output oError Ave</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getOutput__oSpeedAve <em>Output oSpeed Ave</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getOutput__oWref <em>Output oWref</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getOutput__oTargetPosition <em>Output oTarget Position</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getOutput__oKeepState <em>Output oKeep State</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getOutput__oSeekState <em>Output oSeek State</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getOutput__oMotorize <em>Output oMotorize</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getOutput__oRealObjetive <em>Output oReal Objetive</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getOutput__oControlMode <em>Output oControl Mode</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getParameter__pOffset <em>Parameter pOffset</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getParameter__pEncoderOffset <em>Parameter pEncoder Offset</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getParameter__pNextHoleDegrees <em>Parameter pNext Hole Degrees</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getParameter__pPosRate1 <em>Parameter pPos Rate1</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getParameter__pPosRate2 <em>Parameter pPos Rate2</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getParameter__pMaxSpeed <em>Parameter pMax Speed</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getParameter__pSampleTime <em>Parameter pSample Time</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getParameter__pMaxTorque <em>Parameter pMax Torque</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getParameter__pAverageTime <em>Parameter pAverage Time</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getParameter__pSpeedAverageTime <em>Parameter pSpeed Average Time</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getParameter__pMaxAcceleration <em>Parameter pMax Acceleration</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getParameter__pKpp <em>Parameter pKpp</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getParameter__pKps <em>Parameter pKps</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getParameter__pKis <em>Parameter pKis</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getParameter__pFilterOK <em>Parameter pFilter OK</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getParameter__pFilterFreq <em>Parameter pFilter Freq</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getParameter__pFilterDamp <em>Parameter pFilter Damp</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getParameter__pKp2 <em>Parameter pKp2</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getParameter__pKp1 <em>Parameter pKp1</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getParameter__pKi1 <em>Parameter pKi1</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getParameter__pKi2 <em>Parameter pKi2</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getParameter__pPosBand <em>Parameter pPos Band</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit63Impl#getBhvParam__bpControlMode <em>Bhv Param bp Control Mode</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
