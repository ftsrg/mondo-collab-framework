...
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.CtrlUnit13;
 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit13Impl#getInput__iSelect <em>Input iSelect</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit13Impl#getInput__iInput1 <em>Input iInput1</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit13Impl#getInput__iInput2 <em>Input iInput2</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit13Impl#getOutput__oOutput <em>Output oOutput</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit13Impl#getParameter__pParam1 <em>Parameter pParam1</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit13Impl#getParameter__pParam2 <em>Parameter pParam2</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit13Impl#getBhvParam__bpType <em>Bhv Param bp Type</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit13Impl#getBhvParam__bpInputType <em>Bhv Param bp Input Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
