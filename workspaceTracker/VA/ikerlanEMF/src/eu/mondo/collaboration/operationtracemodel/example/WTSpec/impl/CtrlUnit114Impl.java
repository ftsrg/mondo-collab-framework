...
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.CtrlUnit114;
 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit114Impl#getInput__iWindDirectionRaw <em>Input iWind Direction Raw</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit114Impl#getInput__iNacelleDirection <em>Input iNacelle Direction</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit114Impl#getOutput__oWindDirection <em>Output oWind Direction</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit114Impl#getOutput__oWindDirectionAverage <em>Output oWind Direction Average</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit114Impl#getOutput__oWindDirectionDispAbsolute <em>Output oWind Direction Disp Absolute</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit114Impl#getOutput__oWindDirectionDispRelative <em>Output oWind Direction Disp Relative</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit114Impl#getParameter__pVaneOffset <em>Parameter pVane Offset</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
