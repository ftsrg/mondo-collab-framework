 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit23Impl#getInput__iWindSpeed <em>Input iWind Speed</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit23Impl#getInput__iInverterPower <em>Input iInverter Power</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit23Impl#getOutput__oRelationError <em>Output oRelation Error</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit23Impl#getParameter__pWindSpeedLimit <em>Parameter pWind Speed Limit</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit23Impl#getParameter__pInverterPowerLimit <em>Parameter pInverter Power Limit</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit23Impl#getTimer__tWindMinimumTime <em>Timer tWind Minimum Time</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit23Impl#getTimer__tPowerAndWindMinimumTime <em>Timer tPower And Wind Minimum Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
