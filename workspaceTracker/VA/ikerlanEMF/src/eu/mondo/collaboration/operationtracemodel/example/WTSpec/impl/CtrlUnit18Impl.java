 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit18Impl#getInput__iOrderCw <em>Input iOrder Cw</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit18Impl#getInput__iOrderCcw <em>Input iOrder Ccw</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit18Impl#getInput__iFault <em>Input iFault</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit18Impl#getInput__iCmdDisable <em>Input iCmd Disable</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit18Impl#getInput__iCmdReset <em>Input iCmd Reset</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit18Impl#getInput__iStaReadyToOn <em>Input iSta Ready To On</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit18Impl#getOutput__oControlWord <em>Output oControl Word</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit18Impl#getParameter__pCmdDisabled <em>Parameter pCmd Disabled</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit18Impl#getParameter__pCmdEnabled <em>Parameter pCmd Enabled</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit18Impl#getParameter__pCmdCw <em>Parameter pCmd Cw</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit18Impl#getParameter__pCmdCcw <em>Parameter pCmd Ccw</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit18Impl#getParameter__pCmdReset <em>Parameter pCmd Reset</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit18Impl#getParameter__pCmdSwitchOn <em>Parameter pCmd Switch On</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit18Impl#getParameter__pCmdBraking <em>Parameter pCmd Braking</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit18Impl#getTimer__tDelay <em>Timer tDelay</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
