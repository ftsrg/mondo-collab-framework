...
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.CtrlUnit48;
 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit48Impl#getInput__iTemp1 <em>Input iTemp1</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit48Impl#getInput__iTemp2 <em>Input iTemp2</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit48Impl#getInput__iTemp3 <em>Input iTemp3</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit48Impl#getOutput__oFan <em>Output oFan</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit48Impl#getParameter__pTempLimit1 <em>Parameter pTemp Limit1</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit48Impl#getParameter__pTempLimit2 <em>Parameter pTemp Limit2</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit48Impl#getParameter__pTempLimit3 <em>Parameter pTemp Limit3</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit48Impl#getFault__fFault1 <em>Fault fFault1</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit48Impl#getErrorReaction__erReaction1 <em>Error Reaction er Reaction1</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit48Impl#getErrorReaction__erReaction2 <em>Error Reaction er Reaction2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
