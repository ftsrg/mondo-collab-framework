...
import eu.mondo.collaboration.operationtracemodel.example.WTSpec.CtrlUnit109;
 ...
 * <ul>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit109Impl#getInput__iInvHwRun <em>Input iInv Hw Run</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit109Impl#getInput__iVoltageDrop <em>Input iVoltage Drop</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit109Impl#getInput__iTorqueDemand <em>Input iTorque Demand</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit109Impl#getInput__iInvStopOrder <em>Input iInv Stop Order</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit109Impl#getOutput__oTorqueReference <em>Output oTorque Reference</em>}</li>
 *   <li>{@link eu.mondo.collaboration.operationtracemodel.example.WTSpec.impl.CtrlUnit109Impl#getErrorReaction__erStop <em>Error Reaction er Stop</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
