...
public class EOperationImpl extends ETypedElementImpl implements EOperation {
	 ...
	 * @ordered
	 */
	protected EList eGenericExceptions;
	...
	public EList getETypeParameters() {
		if (eTypeParameters == null) {
			eTypeParameters = new EObjectContainmentEList(ETypeParameter.class, this, EcorePackage.EOPERATION__ETYPE_PARAMETERS);
		}
	...
	public EList getEExceptions() {
		if (eExceptions == null) {
			eExceptions = new EObjectResolvingEList.Unsettable(EClassifier.class, this, EcorePackage.EOPERATION__EEXCEPTIONS);
		}
		return eExceptions;
	}
	...
	public EList getEGenericExceptions() {
		if (eGenericExceptions == null) {
			eGenericExceptions = new EObjectContainmentEList.Unsettable(EGenericType.class, this, EcorePackage.EOPERATION__EGENERIC_EXCEPTIONS);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case EcorePackage.EOPERATION__ETYPE_PARAMETERS:
				...
				getETypeParameters().addAll((Collection)newValue);
				return;
			case EcorePackage.EOPERATION__EPARAMETERS:
			...
			case EcorePackage.EOPERATION__EGENERIC_EXCEPTIONS:
				...
				getEGenericExceptions().addAll((Collection)newValue);
				return;
		}
