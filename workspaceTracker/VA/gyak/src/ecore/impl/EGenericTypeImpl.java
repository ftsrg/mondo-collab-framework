...
public class EGenericTypeImpl extends MinimalEObjectImpl.Container implements EGenericType {
	 ...
	 * @ordered
	 */
	protected EList eTypeArguments;
	 ...
	 * @generated
	 */
	public EList getETypeArguments() {
		if (eTypeArguments == null) {
			eTypeArguments = new EObjectContainmentEList(EGenericType.class, this, EcorePackage.EGENERIC_TYPE__ETYPE_ARGUMENTS);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case EcorePackage.EGENERIC_TYPE__ETYPE_ARGUMENTS:
				...
				getETypeArguments().addAll((Collection)newValue);
				return;
			case EcorePackage.EGENERIC_TYPE__ELOWER_BOUND:
