...
public class ETypeParameterImpl extends ENamedElementImpl implements ETypeParameter {
	 ...
	 * @generated
	 */
	public EList getEBounds() {
		if (eBounds == null) {
			eBounds = new EObjectContainmentEList(EGenericType.class, this, EcorePackage.ETYPE_PARAMETER__EBOUNDS);
		}
		return eBounds;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case EcorePackage.ETYPE_PARAMETER__EBOUNDS:
				getEBounds().clear();
				getEBounds().addAll((Collection)newValue);
				return;
		}
