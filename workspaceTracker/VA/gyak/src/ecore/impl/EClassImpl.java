...
public class EClassImpl extends EClassifierImpl implements EClass {
	...
	public EList getESuperTypes() {
		if (eSuperTypes == null) {
			eSuperTypes = new EObjectResolvingEList.Unsettable(EClass.class, this, EcorePackage.ECLASS__ESUPER_TYPES);
		}
		return eSuperTypes;
	}
	...
	public EList getEGenericSuperTypes() {
		if (eGenericSuperTypes == null) {
			eGenericSuperTypes = new EObjectContainmentEList.Unsettable(EGenericType.class, this, EcorePackage.ECLASS__EGENERIC_SUPER_TYPES);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case EcorePackage.ECLASS__EGENERIC_SUPER_TYPES:
				...
				getEGenericSuperTypes().addAll((Collection)newValue);
				return;
		}
