...
import gyak.model.webpage.impl.WebpagePackageImpl;
...
public class EcorePackageImpl extends EPackageImpl implements EcorePackage {
	...
	public static EcorePackage init() {
		...
		WebpagePackageImpl theWebpagePackage = (WebpagePackageImpl)(EPackage.Registry.INSTANCE.getEPackage(WebpagePackage.eNS_URI) instanceof WebpagePackageImpl ? EPackage.Registry.INSTANCE.getEPackage(WebpagePackage.eNS_URI) : WebpagePackage.eINSTANCE);
	...
	public void initializePackageContents() {
		...
		EOperation op = addEOperation(eClassEClass, this.getEBoolean(), "isSuperTypeOf", 0, 1);
		...
		addEParameter(op, this.getEInt(), "featureID", 0, 1);

		op = addEOperation(eClassEClass, this.getEInt(), "getFeatureID", 0, 1);
		addEParameter(op, this.getEStructuralFeature(), "feature", 0, 1);

		op = addEOperation(eClassEClass, this.getEStructuralFeature(), "getEStructuralFeature", 0, 1);
		addEParameter(op, this.getEString(), "featureName", 0, 1);

		addEOperation(eClassEClass, this.getEInt(), "getOperationCount", 0, 1);

		op = addEOperation(eClassEClass, this.getEOperation(), "getEOperation", 0, 1);
		addEParameter(op, this.getEInt(), "operationID", 0, 1);

		op = addEOperation(eClassEClass, this.getEInt(), "getOperationID", 0, 1);
		addEParameter(op, this.getEOperation(), "operation", 0, 1);

		op = addEOperation(eClassEClass, this.getEOperation(), "getOverride", 0, 1);
		addEParameter(op, this.getEOperation(), "operation", 0, 1);

		op = addEOperation(eClassEClass, this.getEGenericType(), "getFeatureType", 0, 1);
		addEParameter(op, this.getEStructuralFeature(), "feature", 0, 1);
		...
		op = addEOperation(eClassifierEClass, this.getEBoolean(), "isInstance", 0, 1);
		addEParameter(op, this.getEJavaObject(), "object", 0, 1);

		addEOperation(eClassifierEClass, this.getEInt(), "getClassifierID", 0, 1);
		...
		addEParameter(op, this.getEString(), "name", 0, 1);

		op = addEOperation(eEnumEClass, this.getEEnumLiteral(), "getEEnumLiteral", 0, 1);
		addEParameter(op, this.getEInt(), "value", 0, 1);

		op = addEOperation(eEnumEClass, this.getEEnumLiteral(), "getEEnumLiteralByLiteral", 0, 1);
		addEParameter(op, this.getEString(), "literal", 0, 1);
		...
		addEParameter(op, this.getEString(), "literalValue", 0, 1);

		op = addEOperation(eFactoryEClass, this.getEString(), "convertToString", 0, 1);
		addEParameter(op, this.getEDataType(), "eDataType", 0, 1);
		...
		addEParameter(op, this.getEString(), "source", 0, 1);
		...
		op = addEOperation(eObjectEClass, this.getEJavaObject(), "eGet", 0, 1);
		addEParameter(op, this.getEStructuralFeature(), "feature", 0, 1);
		addEParameter(op, this.getEBoolean(), "resolve", 0, 1);
		...
		op = addEOperation(eObjectEClass, this.getEJavaObject(), "eInvoke", 0, 1);
		addEParameter(op, this.getEOperation(), "operation", 0, 1);
		addEParameter(op, this.getEEList(), "arguments", 0, 1);
		...
		addEOperation(eOperationEClass, this.getEInt(), "getOperationID", 0, 1);

		op = addEOperation(eOperationEClass, this.getEBoolean(), "isOverrideOf", 0, 1);
		addEParameter(op, this.getEOperation(), "someOperation", 0, 1);
		...
		addEOperation(eStructuralFeatureEClass, this.getEInt(), "getFeatureID", 0, 1);
		...
		op = addEOperation(eGenericTypeEClass, this.getEBoolean(), "isInstance", 0, 1);
		addEParameter(op, this.getEJavaObject(), "object", 0, 1);
